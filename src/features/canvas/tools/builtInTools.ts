...
export const removeBackgroundToolPlugin: CanvasToolPlugin = {
  type: NODE_TOOL_TYPES.removeBackground,
  label: '抠图',
  ...
  execute: async (sourceImageUrl, options, context) =>
    await context.processTool(NODE_TOOL_TYPES.removeBackground, sourceImageUrl, options),
};
