...
export type MenuIconKey = 'upload' | 'sparkles' | 'layout' | 'text' | 'clipboardList';
...
const promptNodeDefinition: CanvasNodeDefinition<PromptNodeData> = {
  type: CANVAS_NODE_TYPES.prompt,
  menuLabelKey: 'node.menu.prompt',
  ...
  createDefaultData: () => ({
    displayName: DEFAULT_NODE_DISPLAY_NAME[CANVAS_NODE_TYPES.prompt],
    prompts: [
...
export const canvasNodeDefinitions: Record<CanvasNodeType, CanvasNodeDefinition> = {
  ...
  [CANVAS_NODE_TYPES.prompt]: promptNodeDefinition,
};
